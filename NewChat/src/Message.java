...
public class Message implements Serializable {
    ...
    public Message(String username, Object data){
        this.username = username;
        this.data = data;
        this.time = Calendar.getInstance().getTime();
    }

    public Message(String username, Object data, int type){
        this(username, data);
        this.type = type;
    }

    // Constructor for data to many people
    public Message(String username, Object data, int type, String[] users){
